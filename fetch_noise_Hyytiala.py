...
# %%
file_save = 'G:\CloudnetData\Hyytiala\CL61\Raw_processed/'
diag_save = 'G:\CloudnetData\Hyytiala\CL61\Bk_noise/'
files = glob.glob('G:\CloudnetData\Hyytiala\CL61\Raw/' + '*.nc')
